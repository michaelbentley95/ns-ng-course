...
export class AuthService {
    ...
    /**
     * Sets the time to automatically log the user out of the applicaiton
     * @param expiryDuration The amount of time left on the user's token
     */
    ...
    private handleLogin(email: string, token: string, userId: string, expiresIn: number) {
        //Get expiration date by adding now + expiresIn in milliseconds
